...
public class SubTestJunit extends BaseCalculatorTestJunit {
    ...
    public static Collection subParam() {
    ...
    public SubTestJunit(long a, long b, long expected, long delta, double c, double d, double expD, double deltaD) {
        this.valueOne = a;
        this.valueTwo = b;
        this.valueThree = c;
        this.valueFour = d;
